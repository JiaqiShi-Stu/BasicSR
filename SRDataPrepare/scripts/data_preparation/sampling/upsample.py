...
class upsample():
    def __init__(self,upscale,modscale,input_folder,save_folder):
        ...
        self.downsample_range = [int(upscale),int(upscale)]
    ...
    def generate_bicubic_img(self):
        ...
        save_mod_folder = os.path.join(self.save_folder, f'MODx{self.upscale}')
        save_lr_folder = os.path.join(self.save_folder, f'LRx{self.upscale}')
        save_sr_folder = os.path.join(self.save_folder, f'SRx{self.upscale}')
