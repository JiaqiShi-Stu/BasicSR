...
def process_single_dataset(input_folder,output_folder,crop_size,down_factor):
    ...
    input_folder1 = os.path.join(input_folder, f'MODx{down_factor}')
    save_folder1 = os.path.join(output_folder, f'HRx{down_factor}')
    ...
    input_folder2 = os.path.join(input_folder, f'LRx{down_factor}')
    save_folder2 = os.path.join(output_folder, f'LRx{down_factor}')


    process_single_folder(input_folder2,save_folder2,int(crop_size/down_factor))


    input_folder3 = os.path.join(input_folder, f'SRx{down_factor}')
    save_folder3 = os.path.join(output_folder, f'SRx{down_factor}')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_jpeg', default = True,
        help='name of the data folder')
    parser.add_argument('--up_scale', default = 6,
        help='name of the data folder')
    parser.add_argument('--mod_scale', default = 6,
        help='name of the data folder')
